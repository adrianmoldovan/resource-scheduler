...
public class ResourceSchedulerTest {
	...
	int index = 1;
	Message msg1 = new MessageImpl(1, 1, false, index++);
	scheduler.clear();
	scheduler.add(msg1);
	...
	int index = 1;
	Message msg1 = new MessageImpl(1, 1, false, index++);
	Message msg2 = new MessageImpl(1, 2, false, index++);
	scheduler.clear();
	scheduler.add(msg1);
	scheduler.add(msg2);
	...
	int index = 1;
	Message msg1 = new MessageImpl(1, 1, false, index++);
	Message msg2 = new MessageImpl(2, 2, false, index++);
	Message msg3 = new MessageImpl(3, 1, false, index++);
	Message msg4 = new MessageImpl(4, 0, false, index++);
	Message msg5 = new MessageImpl(5, 1, false, index++);
	scheduler.clear();
	scheduler.add(msg1);
	scheduler.add(msg2);
	scheduler.add(msg3);
	...
	ResourceScheduler scheduler2 = new ResourceScheduler(4,
		ComparatorType.MESSAGEID);
	int index = 1;
	Message msg1 = new MessageImpl(1, 2, false, index++);
	Message msg2 = new MessageImpl(2, 3, false, index++);
	Message msg3 = new MessageImpl(4, 2, false, index++);
	Message msg4 = new MessageImpl(4, 1, false, index++);
	Message msg5 = new MessageImpl(3, 2, false, index++);
	Message msg6 = new MessageImpl(5, 2, false, index++);
	scheduler2.clear();
	scheduler2.add(msg2);
	scheduler2.add(msg1);
	scheduler2.add(msg4);
	...
	TestCase.assertEquals(6, scheduler2.count());
	...
	ResourceScheduler scheduler3 = new ResourceScheduler(4,
		ComparatorType.GROUPID);
	int index = 1;
	Message msg1 = new MessageImpl(1, 2, false, index++);
	Message msg2 = new MessageImpl(2, 3, false, index++);
	Message msg3 = new MessageImpl(3, 2, false, index++);
	Message msg4 = new MessageImpl(4, 1, false, index++);
	Message msg5 = new MessageImpl(5, 4, false, index++);
	Message msg6 = new MessageImpl(6, 2, false, index++);
	scheduler3.clear();
	scheduler3.add(msg1);
	scheduler3.add(msg2);
	scheduler3.add(msg3);
